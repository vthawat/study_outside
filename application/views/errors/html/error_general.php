...
<html lang="en">
  <head>
	...
	<?php $CI =& get_instance();?>
   <link rel="shortcut icon" href="<?=base_url('uiux/web/vendors/ecs/images/app_icons/receipt.png')?>">
    ...
    <link href="<?=base_url('uiux')?>/web/vendors/ecs/css/error-404.css" rel="stylesheet">
  </head>
  <body>
		<div class="container">
		    <div class="row">
